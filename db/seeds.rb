...
stash6 = Stash.create(name: "Next to the fountain",squirrel_id: Squirrel.all.sample.id, snack_id: Snack.all.sample.id, img_url: "https://news.artnet.com/app/news-upload/2014/11/DSCN3410-256x256.jpg")
