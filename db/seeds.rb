...
squirrel4 = Squirrel.create(name: "Sir. Snuggles", bio:"Is a good tree climber. Likes to eat sandwiches", avatar_id: 4)
...
stash5 = Stash.create(name: "Inside of an old tire",squirrel_id: Squirrel.all.sample.id, snack_id: Snack.all.sample.id, img_url: "https://assets.community.lomography.com/fb/e0edf8c04bf07fa581e2a5df59eaf9fc70d345/256x256x1.jpg?auth=3b1a02a65ed9926bd6d47be08e4b3535e41b7496")
stash6 = Stash.create(name: "Next to the fountain",squirrel_id: Squirrel.all.sample.id, snack_id: Snack.all.sample.id, img_url: "https://b3h2.scene7.com/is/image/BedBathandBeyond/92566047170186p?$imagePLP$&wid=256&hei=256")
...
stash9 = Stash.create(name: "Sandcastle by the beach",squirrel_id: Squirrel.all.sample.id, snack_id: Snack.all.sample.id, img_url: "https://cdn141.picsart.com/278223689015201.jpg?c256x256")
